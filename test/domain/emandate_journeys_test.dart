...
void main() {
  ...
  test('committed e-mandate contracts round-trip byte-for-byte', () {
    for (final entry in {
      'contract/emandate-autopay-setup.journey.json': 'emandate-autopay-setup',
      'contract/emandate-cancel.journey.json': 'emandate-cancel',
    }.entries) {
      final raw = File(entry.key).readAsStringSync();
